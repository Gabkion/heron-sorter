...
let lastSendTime = 0; // last time we sent to Arduino
const sendCooldownMs = 2000; // minimum ms between sends (adjustable)
let classifyIntervalMs = 400; // ms between successive classifications (adjustable)
let lastLabel = ""; // track last high-confidence label
let consecutiveCount = 0; // count consecutive frames with same high-confidence label
const requiredConsecutive = 2; // require this many consecutive frames before sending
